...
export default function Home() {
  ...
  return (
    <div className="bg-black text-white overflow-x-hidden min-h-screen" suppressHydrationWarning>
      ...
      {/* Scrollable Content with subtle section snap */}
      <div className="relative z-10 snap-y snap-proximity">
        {/* Fixed Header */}
        <header className="fixed top-0 left-0 right-0 z-50 p-6 sm:p-8 lg:p-10 bg-black/20 backdrop-blur-sm">
          <nav className="flex justify-between items-center max-w-8xl mx-auto">
            ...
            <div className="hidden md:flex space-x-6 lg:space-x-10 text-base tracking-wide">
          ...
          {/* Mobile Menu */}
          {isMobileMenuOpen && (
            <div className="md:hidden mt-6 pb-6 border-t border-gray-600/30">
              <div className="flex flex-col space-y-6 pt-6">
                <a
                  href="#hero"
                  className="text-white hover:text-purple-400 transition-colors text-base tracking-wide"
        ...
        {/* Hero Section */}
        <section id="hero" className="snap-start min-h-screen flex items-center justify-center px-6 sm:px-8 lg:px-10 pt-24 sm:pt-28">
          <div className="max-w-8xl w-full mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              {/* Text Content */}
              <div className="space-y-8 sm:space-y-10 text-center lg:text-left">
                <div>
                  <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-10xl font-bold leading-none mb-6">
                    DHRUV
                    <br />
                  ...
                  <p className="text-gray-200 text-lg sm:text-xl lg:text-2xl leading-relaxed max-w-2xl mx-auto lg:mx-0 break-words">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
                  <a href="#projects" className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-10 py-5 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 text-center text-lg">
                    View My Work
                  </a>
                  <a href="https://drive.google.com/file/d/1tSaMX7MNzzzPduvLHpEFDWDt0we3fK9q/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="border border-gray-600 hover:border-purple-400 text-white px-10 py-5 rounded-full font-semibold transition-all duration-300 hover:bg-purple-400/10 text-center text-lg">
                    Get CV
                  </a>
                </div>
              </div>
              ...
              <div className="hidden lg:flex items-center justify-center">
                <div className="text-center space-y-10">
                  ...
                  <Reveal direction="up" delayMs={120}>
                    <div className="interactive-card max-w-lg mx-auto bg-gray-900/90 backdrop-blur-sm rounded-2xl p-8 border border-purple-500/20 shadow-xl">
                      ...
                      <div className="flex justify-center flex-wrap gap-4 mb-6">
                        <span className="bg-gradient-to-r from-purple-500/30 to-purple-600/30 border border-purple-400/40 text-purple-300 px-5 py-2.5 rounded-full text-base font-medium shadow-lg shadow-purple-500/20 transform transition-all duration-200 hover:scale-105 hover:shadow-purple-500/40 flex items-center gap-2.5">
                        ...
                        <span className="bg-gradient-to-r from-orange-500/30 to-orange-600/30 border border-orange-400/40 text-orange-300 px-5 py-2.5 rounded-full text-base font-medium shadow-lg shadow-orange-500/20 transform transition-all duration-200 hover:scale-105 hover:shadow-orange-500/40 flex items-center gap-2.5">
                          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"></path>
                          </svg>
                          Three.js
                        </span>
                        <span className="bg-gradient-to-r from-blue-500/30 to-blue-600/30 border border-blue-400/40 text-blue-300 px-5 py-2.5 rounded-full text-base font-medium shadow-lg shadow-blue-500/20 transform transition-all duration-200 hover:scale-105 hover:shadow-blue-500/40 flex items-center gap-2.5">
                          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
                        ...
                        <span className="bg-gradient-to-r from-teal-500/30 to-teal-600/30 border border-teal-400/40 text-teal-300 px-5 py-2.5 rounded-full text-base font-medium shadow-lg shadow-teal-500/20 transform transition-all duration-200 hover:scale-105 hover:shadow-teal-500/40 flex items-center gap-2.5">
                          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
                            <path d="M12.001 4.8c-3.2 0-5.2 1.6-6 4.8 1.2-1.6 2.6-2.2 4.2-1.8.913.228 1.565.89 2.288 1.624C13.666 10.618 15.027 12 18.001 12c3.2 0 5.2-1.6 6-4.8-1.2 1.6-2.6 2.2-4.2 1.8-.913-.228-1.565-.89-2.288-1.624C16.337 6.182 14.976 4.8 12.001 4.8zm-6 7.2c-3.2 0-5.2 1.6-6 4.8 1.2-1.6 2.6-2.2 4.2-1.8.913.228 1.565.89 2.288 1.624 1.177 1.194 2.538 2.576 5.512 2.576 3.2 0 5.2-1.6 6-4.8-1.2 1.6-2.6 2.2-4.2 1.8-.913-.228-1.565-.89-2.288-1.624C10.337 13.382 8.976 12 6.001 12z"></path>
                          </svg>
                          Tailwind
                        </span>
                        <span className="bg-gradient-to-r from-yellow-500/30 to-yellow-600/30 border border-yellow-400/40 text-yellow-300 px-5 py-2.5 rounded-full text-base font-medium shadow-lg shadow-yellow-500/20 transform transition-all duration-200 hover:scale-105 hover:shadow-yellow-500/40 flex items-center gap-2.5">
                          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
                        ...
                        <span className="bg-gradient-to-r from-green-500/30 to-green-600/30 border border-green-400/40 text-green-300 px-5 py-2.5 rounded-full text-base font-medium shadow-lg shadow-green-500/20 transform transition-all duration-200 hover:scale-105 hover:shadow-green-500/40 flex items-center gap-2.5">
                          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
                        ...
                        <span className="bg-gradient-to-r from-indigo-500/30 to-indigo-600/30 border border-indigo-400/40 text-indigo-300 px-5 py-2.5 rounded-full text-base font-medium shadow-lg shadow-indigo-500/20 transform transition-all duration-200 hover:scale-105 hover:shadow-indigo-500/40 flex items-center gap-2.5">
                          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
                        ...
                        <span className="bg-gradient-to-r from-red-500/30 to-red-600/30 border border-red-400/40 text-red-300 px-5 py-2.5 rounded-full text-base font-medium shadow-lg shadow-red-500/20 transform transition-all duration-200 hover:scale-105 hover:shadow-red-500/40 flex items-center gap-2.5">
                          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
                            <path d="M5.8 21l.4-2h9.6l.4 2h-10.4zm-.2-3l1.9-9h9l1.9 9H5.6zM12 2l3 3h4l-5 5-2-2-2 2L5 5h4l3-3z"></path>
                          </svg>
                          NoSQL
                        </span>
                        <span className="bg-gradient-to-r from-emerald-500/30 to-emerald-600/30 border border-emerald-400/40 text-emerald-300 px-5 py-2.5 rounded-full text-base font-medium shadow-lg shadow-emerald-500/20 transform transition-all duration-200 hover:scale-105 hover:shadow-emerald-500/40 flex items-center gap-2.5">
                          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
                      ...
                      <div className="flex justify-center flex-wrap gap-3">
                        <span className="bg-black/30 backdrop-blur-xs border border-gray-600/30 text-gray-300 px-4 py-2 rounded-full text-sm">TypeScript</span>
                        <span className="bg-black/30 backdrop-blur-xs border border-gray-600/30 text-gray-300 px-4 py-2 rounded-full text-sm">Solidity</span>
                        <span className="bg-black/30 backdrop-blur-xs border border-gray-600/30 text-gray-300 px-4 py-2 rounded-full text-sm">C</span>
                        <span className="bg-black/30 backdrop-blur-xs border border-gray-600/30 text-gray-300 px-4 py-2 rounded-full text-sm">C++</span>
                        <span className="bg-black/30 backdrop-blur-xs border border-gray-600/30 text-gray-300 px-4 py-2 rounded-full text-sm">Rust</span>
                        <span className="bg-black/30 backdrop-blur-xs border border-gray-600/30 text-gray-300 px-4 py-2 rounded-full text-sm">Node.js</span>
                      </div>
                    </div>
                  </Reveal>
                </div>
        ...
        {/* Experience Section */}
        <section id="experience" className="snap-start min-h-screen flex items-center justify-center px-6 sm:px-8 lg:px-10 py-20 sm:py-24 lg:py-28 bg-black/20 backdrop-blur-none">
          <div className="max-w-8xl w-full mx-auto">
            <div className="text-center mb-16 sm:mb-20">
              ...
              <p className="text-gray-200 text-lg sm:text-xl max-w-3xl mx-auto px-6">
            ...
            <div className="relative">
              ...
              <div className="absolute left-8 md:left-1/2 md:transform md:-translate-x-1/2 w-1.5 h-full bg-gradient-to-b from-emerald-500 to-lime-500"></div>
        ...
        {/* Projects Section */}
        <section id="projects" className="snap-start min-h-screen flex items-center justify-center px-6 sm:px-8 lg:px-10 py-20 sm:py-24 lg:py-28 bg-black/20 backdrop-blur-none">
          <div className="max-w-8xl w-full mx-auto">
            <div className="text-center mb-16 sm:mb-20">
              <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 sm:mb-8">
            ...
            <div className="relative">
              {/* Timeline Line - Center on desktop, left on mobile */}
              <div className="absolute left-8 md:left-1/2 md:transform md:-translate-x-1/2 w-1.5 h-full bg-gradient-to-b from-cyan-500 to-purple-500"></div>
                  ...
                  <>
                    {additionalProjects.map((project, index) => (
                      <ProjectCard
                        ...
                        revealDelayMs={(index + projects.length) * 80}
                      />
                    ))}
                  </>
                )}
            ...
            <div className="flex justify-center mt-20">
              <button
                ...
                className="group relative z-10 bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 text-white px-10 py-5 rounded-full font-semibold transition-all duration-500 transform hover:scale-110 flex items-center gap-4 shadow-2xl hover:shadow-purple-500/25 border border-white/10 backdrop-blur-sm text-lg"
              >
        ...
        {/* Contact Section */}
        <section id="contact" className="snap-start min-h-screen flex items-center justify-center px-6 sm:px-8 lg:px-10 py-20 sm:py-24 lg:py-28 bg-black/20 backdrop-blur-none relative overflow-hidden">
          {/* Animated Background Elements */}
          <div className="absolute inset-0 pointer-events-none">
            {/* Floating Particles */}
            <div className="absolute top-1/4 left-1/4 w-2.5 h-2.5 bg-purple-400/30 rounded-full animate-pulse"></div>
            <div className="absolute top-1/3 right-1/4 w-1.5 h-1.5 bg-cyan-400/40 rounded-full animate-ping"></div>
            <div className="absolute bottom-1/4 left-1/3 w-3.5 h-3.5 bg-pink-400/20 rounded-full animate-bounce"></div>
            <div className="absolute bottom-1/3 right-1/3 w-2 h-2 bg-emerald-400/30 rounded-full animate-pulse"></div>
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gradient-to-r from-pink-500/5 to-purple-500/5 rounded-full blur-2xl animate-pulse delay-500"></div>
          </div>
          ...
          <div className="max-w-8xl w-full mx-auto relative z-10">
            ...
            <div className="text-center mb-20">
              <div className="inline-block relative">
                <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-8 relative">
                  ...
                  <div className="absolute -inset-2.5 bg-gradient-to-r from-purple-500/20 to-cyan-500/20 blur-xl rounded-lg opacity-50 group-hover:opacity-100 transition-opacity duration-500"></div>
                </h2>
              </div>
              <p className="text-gray-200 text-xl sm:text-2xl max-w-4xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
              ...
              <div className="space-y-10">
                <div className="bg-gray-900/90 backdrop-blur-md p-10 rounded-2xl border border-purple-500/20 shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <form className="space-y-8" onSubmit={handleSubmit}>
                      {/* Name Input */}
                      <div className="group">
                        <label className="block text-base font-medium text-gray-300 mb-2.5 group-focus-within:text-purple-400 transition-colors">
                          Full Name
                        </label>
                        <div className="relative">
                          <input
                            ...
                            className="w-full px-5 py-4 bg-black/50 border border-gray-600/50 rounded-xl text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 focus:outline-none transition-all duration-300 group-hover:border-gray-500 text-lg"
                      ...
                      {/* Email Input */}
                      <div className="group">
                        <label className="block text-base font-medium text-gray-300 mb-2.5 group-focus-within:text-cyan-400 transition-colors">
                          Email Address
                        </label>
                        <div className="relative">
                          <input
                            ...
                            onChange={handleInputChange}
                            className="w-full px-5 py-4 bg-black/50 border border-gray-600/50 rounded-xl text-white placeholder-gray-400 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 focus:outline-none transition-all duration-300 group-hover:border-gray-500 text-lg"
                      ...
                      {/* Subject Input */}
                      <div className="group">
                        <label className="block text-base font-medium text-gray-300 mb-2.5 group-focus-within:text-pink-400 transition-colors">
                          Subject
                        </label>
                        <div className="relative">
                          <input
                            ...
                            onChange={handleInputChange}
                            className="w-full px-5 py-4 bg-black/50 border border-gray-600/50 rounded-xl text-white placeholder-gray-400 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20 focus:outline-none transition-all duration-300 group-hover:border-gray-500 text-lg"
                      ...
                      {/* Message Textarea */}
                      <div className="group">
                        <label className="block text-base font-medium text-gray-300 mb-2.5 group-focus-within:text-emerald-400 transition-colors">
                          Message
                        </label>
                        <div className="relative">
                          <textarea
                            ...
                            onChange={handleInputChange}
                            className="w-full px-5 py-4 bg-black/50 border border-gray-600/50 rounded-xl text-white placeholder-gray-400 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 focus:outline-none transition-all duration-300 resize-none group-hover:border-gray-500 text-lg"
                      ...
                      <div className="pt-6">
                        <button
                          ...
                          className="group relative w-full bg-gradient-to-r from-purple-500 via-pink-500 to-cyan-500 hover:from-purple-600 hover:via-pink-600 hover:to-cyan-600 text-white font-semibold py-5 px-8 rounded-xl transition-all duration-500 transform hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/25 overflow-hidden disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none text-lg"
                        >
                      ...
                      {/* Status Message */}
                      {submitStatus && (
                        <div className="mt-6 p-5 rounded-xl bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30">
                          <p className="text-green-300 text-base font-medium text-center">
                            {submitStatus}
                          </p>
                        </div>
                      )}
                ...
                {/* Quick Contact Info */}
                <div className="bg-gray-900/90 backdrop-blur-md p-8 rounded-2xl border border-cyan-500/20 shadow-xl">
                  <h4 className="text-xl font-semibold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">
                    Quick Contact
                  </h4>
                  <div className="space-y-4">
                    <div className="flex items-center gap-4 text-gray-200 hover:text-cyan-400 transition-colors">
                      ...
                      <div>
                        ...
                        <a href="mailto:dhruvsinghxd@gmail.com" className="font-medium text-lg">dhruvsinghxd@gmail.com</a>
                      </div>
                    </div>



                    <div className="flex items-center gap-4 text-gray-200 hover:text-emerald-400 transition-colors">
              ...
              <div className="space-y-10">
                ...
                <div className="grid grid-cols-2 gap-6">
                  {/* LinkedIn Card */}
                  <a href="https://www.linkedin.com/in/dhruv-singh-94340b28a/" target="_blank" rel="noopener noreferrer" className="group relative bg-gradient-to-br from-blue-900/50 to-blue-800/30 p-8 rounded-2xl border border-blue-500/30 hover:border-blue-400/60 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div className="relative z-10">
                      <div className="w-14 h-14 bg-blue-500/20 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
                      ...
                      <p className="text-blue-300 text-base">Professional Network</p>
                    </div>
                  </a>

                  {/* GitHub Card */}
                  <a href="https://github.com/DhruvArvindSingh" target="_blank" rel="noopener noreferrer" className="group relative bg-gradient-to-br from-gray-900/50 to-gray-800/30 p-8 rounded-2xl border border-gray-500/30 hover:border-gray-400/60 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:shadow-gray-500/25 overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <div className="w-14 h-14 bg-gray-500/20 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
                      ...
                      <p className="text-gray-300 text-base">Code Repository</p>
                    </div>
                  </a>

                  {/* Twitter/X Card */}
                  <a href="https://x.com/dhruvsingh17991" target="_blank" rel="noopener noreferrer" className="group relative bg-gradient-to-br from-sky-900/50 to-sky-800/30 p-8 rounded-2xl border border-sky-500/30 hover:border-sky-400/60 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:shadow-sky-500/25 overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <div className="w-14 h-14 bg-sky-500/20 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
                      ...
                      <p className="text-sky-300 text-base">Latest Updates</p>
                    </div>
                  </a>

                  {/* Discord Card */}
                  <a href="https://discord.com/users/756584429249626120" className="group relative bg-gradient-to-br from-indigo-900/50 to-indigo-800/30 p-8 rounded-2xl border border-indigo-500/30 hover:border-indigo-400/60 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:shadow-indigo-500/25 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div className="relative z-10">
                      <div className="w-14 h-14 bg-indigo-500/20 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
                      ...
                      <p className="text-indigo-300 text-base">Chat & Collaborate</p>
                    </div>
                  </a>
                </div>

                {/* Availability Status */}
                <div className="bg-gradient-to-r from-emerald-900/50 to-green-800/30 p-8 rounded-2xl border border-emerald-500/30 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-5">
                      <div className="relative">
                        ...
                        <div className="absolute inset-0 w-5 h-5 bg-emerald-500 rounded-full animate-ping"></div>
                      </div>
                      <h3 className="text-xl font-semibold text-emerald-400">Currently Available</h3>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      <span className="px-4 py-2 bg-emerald-500/20 text-emerald-300 text-sm rounded-full border border-emerald-500/30">Freelance</span>
                      <span className="px-4 py-2 bg-emerald-500/20 text-emerald-300 text-sm rounded-full border border-emerald-500/30">Full-time</span>
                      <span className="px-4 py-2 bg-emerald-500/20 text-emerald-300 text-sm rounded-full border border-emerald-500/30">Consulting</span>
                    </div>
                  </div>
                </div>

                {/* Fun Fact Card */}
                <div className="bg-gradient-to-r from-amber-900/50 to-orange-800/30 p-8 rounded-2xl border border-amber-500/30 relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <h3 className="text-xl font-semibold text-amber-400">Fun Fact</h3>
                    </div>
            ...
            <div className="text-center mt-20">
              <div className="inline-block bg-gray-900/90 backdrop-blur-md px-10 py-5 rounded-2xl border border-gray-600/30">
