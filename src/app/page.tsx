  ...
  return (
    <div className="bg-black text-white overflow-x-hidden min-h-screen" suppressHydrationWarning>
      ...
      <div className="relative z-10 snap-y snap-proximity">
        ...
        {/* Hero Section */}
        <section id="hero" className="snap-start min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  ...
                  <a href="https://drive.google.com/file/d/1zTdcamlwRLz3tHJ2A_F6rItFxOTCCSiX/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="border border-gray-600 hover:border-purple-400 text-white px-8 py-4 rounded-full font-medium transition-all duration-300 hover:bg-purple-400/10 text-center">
                    Get CV
                  </a>
                </div>
              </div>
              ...
              <div className="hidden lg:flex items-center justify-center">
                <div className="text-center space-y-8">
                  ...
                  <Reveal direction="up" delayMs={120}>
                    <div className="interactive-card max-w-md mx-auto bg-gray-900/90 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/20 shadow-xl">
        ...
        {/* Experience Section */}
        <section id="experience" className="snap-start min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 bg-black/20 backdrop-blur-none">
          <div className="max-w-7xl w-full mx-auto">
            ...
            <div className="relative">
              ...
              <div className="absolute left-6 md:left-1/2 md:transform md:-translate-x-1/2 w-1 h-full bg-gradient-to-b from-emerald-500 to-lime-500"></div>
        ...
        {/* Contact Section */}
        <section id="contact" className="snap-start min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 bg-black/20 backdrop-blur-none relative overflow-hidden">
