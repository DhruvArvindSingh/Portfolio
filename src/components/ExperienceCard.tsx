                    ...
                    >
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <div className="flex-1 text-right">
                                ...
                                {companyUrl ? (
                                    <a href={companyUrl} className={`text-gray-200 hover:${colors.textHover} transition-colors mb-3 block flex items-center justify-end font-medium text-lg`}>
                                        {company}
                                    ...
                                    <p className="text-gray-200 mb-3 font-medium text-right text-lg">{company}</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex gap-6 flex-wrap">
                            {links.map((link, index) => (
                                <a key={index} href={link.url} className={`${colors.text} hover:${colors.textHover} text-base font-medium transition-all duration-300 flex items-center gap-2 hover:gap-3 break-all`}>
                                    {link.label}
                        ...
                        <div className="w-5/12 text-right pr-12">
                            ...
                            >
                                ...
                                {companyUrl ? (
                                    <a href={companyUrl} className={`text-gray-200 hover:${colors.textHover} transition-colors mb-3 block flex items-center justify-end font-medium text-lg`}>
                                        {company}
                                        <svg className="w-5 h-5 ml-1.5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                        </svg>
                                    </a>
                                ) : (
                    ...
                    <>
                        ...
                        <div className="w-5/12 pl-12">
                            ...
                            >
                                ...
                                {companyUrl ? (
                                    <a href={companyUrl} className={`text-gray-200 hover:${colors.textHover} transition-colors mb-3 block flex items-center font-medium text-lg`}>
                                        {company}
                                        <svg className="w-5 h-5 ml-1.5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                        </svg>
                                    ...
                                    <p className="text-gray-200 mb-3 font-medium text-left text-lg">{company}</p>
                                )}
                                <p className="text-base text-gray-300 mb-6 break-words leading-relaxed">{description}</p>
                                <div className="flex gap-3 text-sm mb-6 justify-start flex-wrap">
                                    {technologies.map((tech, index) => {
                                        const techColors = colorMap[tech.color]
                                        return (
                                            <span key={index} className={`${techColors.bgLight} ${techColors.text} px-4 py-2 rounded-full font-medium border ${techColors.borderLight} hover:${techColors.borderHover} transition-all duration-300 transform hover:scale-105`}>
