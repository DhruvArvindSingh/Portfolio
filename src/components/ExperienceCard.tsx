...
/**
 * @description A card component that displays information about a work experience.
            ...
            <div className="hidden md:flex items-center justify-between w-full">
                {isLeft ? (
                    <>
                        ...
                        <div className={`relative z-10 w-6 h-6 ${colors.bg} rounded-full border-4 border-black shadow-lg ${colors.shadow} group-hover:${colors.shadowHover} transition-all duration-30_300`}></div>
