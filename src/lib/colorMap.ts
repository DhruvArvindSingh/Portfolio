...
export const colorMap = {
    ...
    teal: {
        ...
        borderHover: 'border-teal-500/40',
        text: 'text-teal-400',
    ...
    yellow: {
        ...
        borderHover: 'border-yellow-500/40',
    ...
    gray: {
        ...
        borderHover: 'border-gray-500/40',
        text: 'text-gray-400',
        textHover: 'text-gray-300',
        bgLight: 'bg-gray-500/20',
        shadow: 'shadow-gray-500/20',
        shadowHover: 'shadow-gray-500/40'
    }
}
